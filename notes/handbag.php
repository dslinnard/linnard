...
<head>
  ...
  <script src="https://use.fontawesome.com/60dc78d11a.js"></script>
  ...
  <div class="container">
    <div class="row">
      <div class="col-xs-12">
        ...
        <p>Last updated 3rd February, 2017.</p>
        <?php $i="1"; ?>
        <ul class="pageIndex">
          ...
          <li><?php echo $i;?> <a href="#a<?php echo $i++;?>">Variants</a></li>
          <li><?php echo $i;?> <a href="#a<?php echo $i++;?>">Odds &amp; ends</a></li>
          <li><?php echo $i;?> <a href="#a<?php echo $i++;?>">Order of construction</a></li>
          <li><?php echo $i;?> <a href="#a<?php echo $i++;?>">What I don't like</a></li>
          <li><?php echo $i;?> <a href="#a<?php echo $i++;?>">Templates</a></li>
        </ul>

        <?php $i=1;?>
        <h2 id="a<?php echo $i++;?>">&sect;1. Moulding flat panel <a href="#top" title="top of page"><i class="fa fa-arrow-up" aria-hidden="true"></i></a></h2>
        ...
        sanding an AwlBrite coated shell (no veil) and there are little pin holes where I can see straight through. They are filled will epoxy, but I hope that when I pull the peel ply off it doesn't leave holes (it did not). It would be nice if I could make two panels in one go.</p>
        ...
        <div class="subSection">
          ...
          <p>I did try spraying the waxed glass with <a href="http://westsystem.com/ss/mold-release-pva-and-hairspray">hair spray</a> and then applying a thin layer of epoxy by brush, allowing this to cure till touch dry before applying the carbon etc. This worked great and the voids were reduced by about 95%. The downside of this was that the resulting sheet was about twice as thick and when I formed the lips, I had a slight rippling. I am still getting slight rippling in MC6 which didn't have the initail layer of epoxy which I think now is caused by forcing the carbon into the curvature. </p>

          <h4>&sect;1.2.4 Reverse layup</h4>
          <p>My latest attempt is a reverse layup schedule. First lie the veil onto peel ply (I tape a ruler to the edge of the peel ply so I can lift the ply and carbon without distoring it) and soak the veil well with resin, roll it well it to make sure the slow cure epoxy saturates the cloth and then apply the carbon twill, again saturating it with epoxy and rolling well. I let it sit for maybe twenty minutes to give the resin time to soak into the fibres and then rolled again. I then turned it over onto the glass and rolled again. The results of this were almost as good as my previous approach of adding an initial resin layer. When I was doing my test piece I coated the waxed glass with hair spray. This leaves a matt finish to the carbon which may give a better surface for the polyurathane to bond to.</p>

          <p>To double check this method again I did another sheet of carbon (exhibit A), waxing the glass, did a reverse layout with slow epoxy, coating the glass with epoxy and rolling between layers. Instead of the previous good results I had the usual small voids everywhere. I couldn't understand this so I decided to do some test pieces using glass coated with my spray release film (all were rolled):</p>

          <ul><li>Exhibit B. glass, twill, veil &amp; ply</li>
          <li>Exhibit C. glass, epoxy, twill, veil &amp; ply</li>
          <li>Exhibit D. ply, veil, twill (reverse layout) &amp; epoxy on glass</li></ul>

          <p>All exhibits came out the same and had voids everywhere just as in my previous sheet. What I did notice however was that in all exhibits when I returned the following day the vacuum had gone out of the bag, so I suspect that if the vacuum goes before the resin has cured the carbon fibres expand and suck in the epoxy between the threads, leading to the voids. </p>

          <p>I did another test (exhibit E), using fast epoxy (as I don't want to wait all night), but waiting long enough for the epoxy to gel. The glass I used was half coated in wax, the other half uncoated. I used the same application method as exhibit D. The results of this were better than exhibit A, I did get the small voids everywhere but they were smaller. Also the non-waxed piece came out  slightly better with ever so slightly smaller voids, however it was very difficult to get off the glass.</p>

          <p>The only thing I can think of is that slow cure makes the difference and maybe I rolled more. For this last test I waxed and hairsprayed the glass, taped a ruler to the peel ply and over the glass applied the veil, slow resin and rolled it, twill, slow resin and rolled it. Let it sit for 15 minutes, rolled it again and then turned it over onto the glass, rolled it and bagged it. I stayed there for at least 3 hours with the pump running and it came out great. I used this panel for MC7.</p> 
        ...
        <h3>&sect;1.3 More woes</h3>

        <p>For MC9 I have been trying to make a panel using the patterened labyrinth carbon. So far I have made four attempts, none successful. All were rolled and used slow epoxy.

        <ol><li>Reverse layout, slow epoxy - voids</li>
        <li>Non-reverse layout, coated glass - voids but fewer than in i)</li>
        <li>hairspray on glass, coated glass, reverse layout,  pump running for 3 hours - lots of voids though this time they were covered in a thin film of epoxy which would have been the epoxy I put on the glass. I thought maybe that because I had put the glass epoxy first it had cured before the rest of the epoxy so on the next test the glass epoxy went on last.</li>
        <li>carbon on plastic sheet and coated. Glass coated and then carbon turned onto it and coated again, veil added then coated. Two layers of breather cloth in case the problem was because of over saturatiuon. Pump running for at least three hours -  voids as in iii)</li></ol>

        <p>Through out all these tests the vaccuum pump has been running at about 22.2"Hg. I am wondering whether the voids are caused because this is too low. The pump used to be able to pull about 24", not sure why it can't now. I am now looking into buying a new pump, one that can pull about 29".</p>


        <h2 id="a2">&sect;2. Coating &amp; polishing the panel <a href="#top" title="top of page"><i class="fa fa-arrow-up" aria-hidden="true"></i></a></h2>
        ...
        <h2 id="a3">&sect;3. Creating the curved lip <a href="#top" title="top of page"><i class="fa fa-arrow-up" aria-hidden="true"></i></a></h2>

        <h3>&sect;3.1 The mould</h3>

        <p>The mould is 34.2cm wide and should be at least 14&quot; long. The 9/16&quot; router bit was set to give a <a href="http://www.mathopenref.com/sagitta.html">sagitta</a> of 2mm.</p>
        ...
        <h2 id="a4">&sect;4. Installing the hinge tube <a href="#top" title="top of page"><i class="fa fa-arrow-up" aria-hidden="true"></i></a></h2>
        ...
        <h3>&sect;4.3 Continuous hinge tube</h3>
        ...
        <p>For MC9 I have been thinking again about having a continuos hinge pin. It would allow be to have a much thicker pin and I think I can hold it in place by just having a tight fit.</p>

        <p>If I don't go for a contunuos hinge pin in MC9 then I will use a thicker pin than I previously will. I think I can get a 3mm outer tube with a 2mm hinge pin. I can try this and see how well friction holds it in place. If friction isn't enough then I will just get a Polyimide tube that will hold the 3mm tube and get biiger springs.</p>



        <h2 id="a5">&sect;5. Making the bottom insert <a href="#top" title="top of page"><i class="fa fa-arrow-up" aria-hidden="true"></i></a></h2>

        <h3>&sect;5.1 Mould, MC2 - MC6</h3>

        <p>The inside profile of the mould was based upon a flat section of 1 7/8&quot; with a diameter of 1 3/4&quot;. The outside mould profile is 1 7/8&quot; flat section and curves of diameter 1 7/8&quot;. The length of the inner mould is approximately 8.5&quot; long.</p>

        <h3>&sect;5.2 Mould, MC7</h3>
        <p>The mould for MC7 is being re-designed and the inner mould will be built from acrylic and the outer from fibreglass. Because the dimenisions of the outer mould are more important than those of the inner mould I am concentrating my efforts on getting this as perfect as possible. The radius of both moulds will be 1&quot;. As discussed in &sect;8. to achive a flat apex of 3mm each radius has to be moved in y = 1mm, thus the total width of the acrylic for the outer mould needs to be:</p>

        <p class="equ">4 x 25.4 - 2 x y</p>

        <p class="equ">4 x 25.4 - 2 =&gt; 101.6 - 2 = 99.6mm wide</p>

        <p>Because I am making the outer mould and inner moulds with the same radius this will causes a problem, with the gap between them the same at 180&deg; and 270&deg; but narrowing in between. The narrowest point is at 225&deg; and is equal to:</p>

         <p class="equ">y=z.Cos45&deg; where z is the amount we shift each circle</p>
        ...
        <p class="equ">99.6 - 2.5 = 97.1mm wide.</p> 
        ...
        <h3>&sect;5.2.1 Acrylic Moulds, MC7</h3>
        ...
        <p class="equ">Outer: 99.79mm &amp; 99.49mm a difference of 0.3mm, average = 99.64mm &gt; y = 0.98mm</p>

        <p class="equ">Inner: 97.17mm &amp; 97.06mm a difference of 0.11mm, average = 97.11mm</p>
        ...
        <p class="equ">Lenth of inner bottom panel mould = inner length of side panel (222mm) - 2 x thickness of ultrasuede (0.5mm)  - 2 x thickness of bottom panel ends (1.5mm) - 2 x 0.5mm (to give us an extra little gap)</p>

        <p class="equ">= 222 - 2 x 0.5 - 2 x 1.5 - 2 x 0.5 = 222 - 1 - 3 - 1 = 217mm</p>
        ...
        <p>This is the completed acrylic outer mould for MC7, 8 &amp; 9 and it is used to make the actual outer mould pieces <img src="./images/MC7_outer_mould.png" alt="MC7 outer mould"></p>

        <p>In this image we have the completed acrylic inner mould (the yellow mould) for MC7, 8 &amp; 9. The two blue moulds are actual outer moulds and were made using the above acrylic outer mould. In carbon we see an actual moulded inner piece for a MC7 etc <img src="./images/MC7_inner_mould.png" alt="MC7 inner mould"></p>
         
        <h3>&sect;5.3 Layup</h3>

        <p>The bottom and end plates are now moulded into a single piece, using 5
        ...
        the gussets in the cloth are at a minimal. I mould the piece upright to allow any
        ...
        supposed to mould well to complex shapes (5.5oz 4HS carbon from US Composites).
        ...
        <p>MC9: 5xtwill &amp; 80g epoxy, 16g slow hardener. Ran out of HS4 but twill has a nice drape.</p>



        <h2 id="a6">&sect;6. Building up the lip <a href="#top" title="top of page"><i class="fa fa-arrow-up" aria-hidden="true"></i></a></h2>
        ...
        <h2 id="a7">&sect;7. Closing panel <a href="#top" title="top of page"><i class="fa fa-arrow-up" aria-hidden="true"></i></a></h2>
        ...
        <p>I also have to take into account the fact that the formed piece will extend the depth by it's width of about 1mm. Because the mould has a radius of 3/4&quot; (19.1mm) I sanded the ridge down to 18mm.</p>
        ...
        <h2 id="a8">&sect;8 Final lip finish <a href="#top" title="top of page"><i class="fa fa-arrow-up" aria-hidden="true"></i></a></h2>
        ...
        <p>Achieving a good looking raw carbon finish has previously required that I sand back all the epoxy, otherwise you see variations in colour. This process is surprisingly hard, maybe because I don't want to sand too deep and spoil the twill pattern. On MC8b I discovered that if I get the majority of the epoxy off and then polish it with Nu-wax the resulting darkening of the raw carbon hides all the colour variations.</p>


        <h2 id="a9">&sect;9 Cutting panel to roughly the correct size <a href="#top" title="top of page"><i class="fa fa-arrow-up" aria-hidden="true"></i></a></h2>
        ...
        <p>On MC7 I had already cut the lip back on the saw to about 21mm and using my sanding jig I sanded it back to 20mm.</p>

        <p>For MC8b I made a base that I could rest my large diamond file on, with this I sanded back to 18mm.</p>
        ...
        <h2 id="a10">&sect;10. Making the side brackets <a href="#top" title="top of page"><i class="fa fa-arrow-up" aria-hidden="true"></i></a></h2>

        <h3>&sect;10.1 The mould</h3>
        <p>The side bracket is made between male and female moulds and for MC7 I am going to make a new large mould that can make two side panels at onnce. For this mould the male is one piece and the female two piece. I tried a single female mould but I got bubbles trapped in it. <strong>Note</strong> I am not sure how square the double mould is as if I slide a moulded carbon side panel from left to right it gets tight towards one end, the difference in size may be negligible but woth checking.</p>

        <p>On the left is the original single mould and on the right is the double mould. Also in the image are two roughly cut carbon side pieces.  <img src="./images/MC7_side_moulds.png" alt="MC7 outer mould"></p>
        ...
        <p>MC9: 2xtwill, 3 x plain &amp; 90g epoxy, 18g slow hardener. 39cm is a bit too long so for MC10 use 23cm x 37cm.</p>

 
        <h2 id="a11">&sect;11. Cutting out the side brackets and bottom inserts <a href="#top" title="top of page"><i class="fa fa-arrow-up" aria-hidden="true"></i></a></h2>

        <h3>&sect;11.1 Side panels</h3>
        
        <div class="subSection">
          <h4>&sect;11.1.1 Marking out</h4>
          <p>For the end panels I need to get the two end sections the same size and on the same horizontal plane. For MC6 I used a large right angle draughtmans square to draw a silver line across the panels near an edge. I then extended this around to the sides. I use this line to line up the paper template. <a href="./side_section_mc8.pdf">Template for MC7, 8 &amp; 9</a>.</p>
        ...
        <h3>&sect;11.2 Bottom panel</h3>

        <div class="subSection">
          <h4>&sect;11.2.1 Sides</h4>
          ...
          <h4>&sect;11.2.2 Bottom area</h4>

          <p>I line up the paper template using the vertical line I scribed earlier, tape it down in a few places and mark around it with a silver sharpie. Templates: <a href="./bottom_mc8.pdf">MC8a (10.9cm wide)</a>,&nbsp;&amp;&nbsp;<a href="./bottom_mc8_v2.pdf">MC8b &amp; 9 (10.7cm wide)</a>.</p>
        </div>

        <h4>&sect;11.3 Cutting the panels</h4>
        ...
        <h4>&sect;11.4 Clamping system</h4>
        ...
        <h2 id="a12">&sect;12 Coating and polishing the side sections <a href="#top" title="top of page"><i class="fa fa-arrow-up" aria-hidden="true"></i></a></h2>
        ...
        <h2 id="a13">&sect;13 Ultrasuede arms <a href="#top" title="top of page"><i class="fa fa-arrow-up" aria-hidden="true"></i></a></h2>
        ...
        <h2 id="a14">&sect;14. Fitting the main, closing and bottom panels together <a href="#top" title="top of page"><i class="fa fa-arrow-up" aria-hidden="true"></i></a></h2>
        ...
        <h3>&sect;14.1 Panel and bottom section fit</h3>
        ...
        <p class="equ">p = 2r(tan75&deg; + (2/3)&pi; + 1)  =&gt; 13.6528r</p>
        <p class="equ"> or ph = r6.8264 for half the perimeter</p>
        ...
        <div class="subSection">
          <h4>&sect;14.1.1 Overlapping circles</h4>
          ...
          <p class="equ"> 2(y + y/sin30&deg;) =&gt; 6y</p>  
          ...
          <p class="equ">p = 13.6528r - 6y</p> 

          <p>A flat apex of &quot;x&quot; reduces the perimeter by:</p>
          <p class="equ">x/Sin30&deg; =&gt; 2x</p>

          <p>Thus reducing the perimeter by 2x to gives an apex of &quot;x&quot; mm</p>

          <p class="equ">p + 2x = 13.6528r - 6y</p> 

          <p class="equ">y = <span class="fracNum">(13.6528r - p - 2x)</span>/<span class="fracDen">6</span></p> 

          <p>Now as p is defined by my mould to be 339.725mm we have:</p>

          <p class="equ">y = <span class="fracNum">(13.6528r - 339.725 - 2x)</span>/<span class="fracDen">6</span></p> 
          ...
          <p class="equ"> =&gt; y = (25.4 x 13.6528 - 339.725 - 6)/6 </p>
          <p class="equ">=&gt; y = (346.78 - 345.725)/6 </p>
          <p class="equ">=&gt; y = 1.056/6 </p>
          <p class="equ">=&gt; y = 0.176mm </p>  
          ...
          <p>For p = 340mm:</p>
          <p class="equ">=&gt; y = (346.78 - 340 - 6)/6 </p>
          <p class="equ">=&gt; y = 0.13mm </p>  

          <p>For p = 339mm:</p>
          <p class="equ">=&gt; y = (346.78 - 339 - 6)/6 </p>
          <p class="equ">=&gt; y = 0.3mm </p>  

          <p>For p = 338mm:</p>
          <p class="equ">=&gt; y = (346.78 - 338 - 6)/6 </p>
          <p class="equ">=&gt; y = 0.46mm </p>  

          <p>For p = 337mm:</p>
          <p class="equ">=&gt; y = (346.78 - 337 - 6)/6 </p>
          <p class="equ">=&gt; y = 0.63mm </p>  

          <p>For p = 336mm:</p>
          <p class="equ">=&gt; y = (346.78 - 336 - 6)/6 </p>
          <p class="equ">=&gt; y = 0.8mm </p>  

          <p>For p = 335mm:</p>
          <p class="equ">=&gt; y = (346.78 - 335 - 6)/6 </p>
          <p class="equ">=&gt; y = 0.96mm </p>  

          <p>For p = 334mm:</p>
          <p class="equ">=&gt; y = (346.78 - 334 - 6)/6 </p>
          <p class="equ">=&gt; y = 1.1mm </p>  
        ...
        <h3>&sect;14.2 The closing panels sits snugly over both lips</h3>
        ...
        <h3>&sect;14.3 Closing panel touches the bottom panel and be of the same width as the top of the bottom insert</h3>
        ...
        <h3>&sect;14.4 Fitting the side panels</h3>
        ...
        <h3>&sect;14.5 Lined end panels</h3>
        ...
        <h2 id="a15">&sect;15. Bottom panel stops <a href="#top" title="top of page"><i class="fa fa-arrow-up" aria-hidden="true"></i></a></h2>
        ...
        <h2 id="a16">&sect;16. Recessing the side panels <a href="#top" title="top of page"><i class="fa fa-arrow-up" aria-hidden="true"></i></a></h2>
        ...
        <h2 id="a17">&sect;17. Top panel stops <a href="#top" title="top of page"><i class="fa fa-arrow-up" aria-hidden="true"></i></a></h2>
        ...
        <h2 id="a18">&sect;18. Ultrasuede Frame <a href="#top" title="top of page"><i class="fa fa-arrow-up" aria-hidden="true"></i></a></h2>
        ...
        <p>Once the strips fit well I use multiple clamp along the whole length and use a medium vicosity cyanno, low vicosity runs everywhere. I clamp both of them in place and make sure everything looks fine, I then remove one and glue the other one. Once that has set I glue the remaining one. Be careful of the cyanno running. Once glued I then need to sand the recess into these and make sure the bag closes well. I undersand them cautiously as I want the bag to close perfectly will a miniumum play in the side panels.</p>
        ...
        <p>After the frames have been coated with Awlbrite, sand down any excess from the center sections to give a flat surface for the Ultrasuede.</p>




        <h2 id="a19">&sect;19 Coating and polishing the bottom section <a href="#top" title="top of page"><i class="fa fa-arrow-up" aria-hidden="true"></i></a></h2>

        <h3>&sect;19.1 Coating</h3>
        ...
        <h2 id="a20">&sect;20 Middle stops <a href="#top" title="top of page"><i class="fa fa-arrow-up" aria-hidden="true"></i></a></h2>
        ...
        <h2 id="a21">&sect;21. Panel final cut <a href="#top" title="top of page"><i class="fa fa-arrow-up" aria-hidden="true"></i></a></h2>
        ...
        <h2 id="a22">&sect;22. Clip <a href="#top" title="top of page"><i class="fa fa-arrow-up" aria-hidden="true"></i></a></h2>
        ...
        <p>For MC9 I will make the cutout bigger so that the clip can fold back completly. This will make it less likely for the hing pin to break if it gets caught.</p>


        <h2 id="a23">&sect;23. Ultrasuede templates <a href="#top" title="top of page"><i class="fa fa-arrow-up" aria-hidden="true"></i></a></h2>

        <p>Making cardboard templates for all the ultrasuede cuts outs as well as profiles of the bottom section and the side panels makes cutting the ultrasuede to the right size a lot easier. For the sections of ultrasuede between the bottom and the side sections, I traced out the profiles for them onto cardboard, spacing them about an inche apart. I then re-cut this new template, reducing the distance between them until I got a good fix. May sure they the templates have there location marked on them as well as which is the upper surface.</p>



        <h2 id="a24">&sect;24. Gluing in the bottom panel <a href="#top" title="top of page"><i class="fa fa-arrow-up" aria-hidden="true"></i></a></h2>

        <h3>&sect;24.1 Prerequisites</h3>
        <ul>
          <li>Shell polished</li>
          ...
          <li>Ultrasuede frames added and interior sanded</li>
          <li>Ultrasuede cut out made for the ends</li>
          <li>Cardboard cuts outs made for all remaining ultrasuede areas</li>
          <li>Surfaces washed and grease free</li>
        </ul>
        ...
        <p>Previously I held the bottom panel in place with magnets. The disadvantage of this was that the magnets didn't have enough force to hold it firmly. In MC5 I improved the clamping by having a steel rod running straight through the bag. This did involve cutting 6mm holes through each end but they will be covered/filled up. The use of this clamping system is very useful as I can now clamp the mould down firmly and securely whilst still being able to close the bag. Again as mentioned above I line the mould up as best I can making sure the lips line up etc etc. and then put a pit of cyanno at both ends. By gluing the center section only I can still open up the bag, the advantage of which is that I can finish one half of it (ie. add the ultrasuede etc.) and be able to get a camera in to photograph the details. It also gives me extra room to work on the placing the utrasuede.</p>

        <h3>&sect;24.2 Gluing methods</h3>

        <p>I have tried cyanno only (MC2), epoxy only (MC5 &amp; 7) and a combination of cyanno & epoxy in MC8b. Epoxy is strong than cyanno, but there is going to be enough area to create a strong bond. The cyanno is used to create a "tacK" bond along the center line, so that I can remove the clamping system. The advantage of just tacking along the center line is that I can finish one half of the bag (complete with ultrasuede etc.) and be able to get a camera in to photograph the interior from the other side.</p>

        <p>Tip before applying any cyano make sure the bag is dry otherwise you get a white bloom which is difficult to get off. If I let the cyano cure naturally it cures clear. Don't use low viscosity cyanno, it runs everywhere.</p>

        <h3>&sect;24.3 MC5</h3>

        <p>In MC5 I have glued up one side by applying epoxy to it. You have to be careful to keep the epoxy away from the end panels (I don't want them being glued further up the shell - glue seeps) and I had to be careful removing the excess glue with little bits of cardbaord. I have only epoxied one side so far as I want to keep one side open for photography, but once I have glued up the other side I will go over it with superglue.</p>
        ...
        <h3>&sect;24.5 MC8b</h3>

        <p>With the bag clamped together and fitting snuggly I am now ready to glue in the bottom panel. To make sure the center area of the bottom panel has a good contact I place a wedge underneath it. With medium viscosity cyanno I spot along the bottom center line (two spots in each cut out). I do each spot at a time and tilt the bag so it runs between the carbon. I did a second pass this time moving outwards maybe 5 mm. After letting this cure for a while I can remove the clamp and the shell is now bonded across it's center. I can now fill up the clamping holes with black epoxy - for this I back the inside with a wax coated piece of acrylic which I can clamp against the side.</p>

        <p>The next step is to bond one side with epoxy. The side I choose to bond first is the non-clip side as this side will photograph better. Before I add any glue I mark around the bottom panel with a fine black sharpie, this way I know where to put the glue. I add spots of the glue and smear it to within 2-3 mm of the line and with the side panel in place I close up the bag and hold it that way with elastic bands. After a few minutes I open up the bag and remove any excesss glue and look to see how close to the sharpie line the glue has creeped up. If the glue line is still short of the line I add more glue and reclamp with the bands. I periodically check for and remove excess resin. </p>

        <p>Note. All bags end up with a little ripple along the bottom of the bag. I thought this was beacuse I hadn't clamped the bottom in securely when glueing it, but now I think the curves are introduced where the shell isn't glued to the bottom panel (where the ultrasuede inserts go) and the shell takes on it's own shape. I am not worried about this.</p>



        <h2 id="a25">&sect;25. Gluing the side brackets <a href="#top" title="top of page"><i class="fa fa-arrow-up" aria-hidden="true"></i></a></h2>
        ...
        <p>When resin is cured remove with wet &amp; dry any traces of epoxy in areas that will be visible.</p>


        <h3>&sect;25.1 Problem with bag</h3>
        <p>On all completed bags I notice a slight ripple in the carbon when the bag is open. The ripple is only present at the ends of the bag. I first noticed it on MC7 and initially thought that it was because MC7 had the widesest bottom panel I've ever used and then I noticed that MC2 has the same problem. I did use a thinner bottom panel in MC8b as an experiment but I still got the ripple.</p> 
        ...
        <p>To fix this in MC8b I am redesigning the ends of the side panels such that their outward motion will be restricted. The end panels stops instead of being a &quot;L&quot; section are now a triangular section with the center sction cut out. I plan to glue stops to the end of the botton sections which will restrict how far the side panels can more outward. For MC8b the stops are 4mm length of 10 mm diameter graphite tubes which I will fill with epoxy. I position the stop so that it would pull in the bag just enough to significantly decrease the ripple, then holding the stop in place with my finger I close the bag slightly (so nothing is touching the stop) and add a dap of cyanno. Before glueing these stops on make sure that they are flush with the other stops as sanding them in place is awkward.</p>
                 
        <p>When resin is cured remove with wet &amp; dry any traces of epoxy in areas that will be viible.</p>

        
        <h2 id="a26">&sect;26. Gluing in the end panel ultrasuede <a href="#top" title="top of page"><i class="fa fa-arrow-up" aria-hidden="true"></i></a></h2>
        ...
        <h2 id="a27">&sect;27. Middle panel stops</h2>
        ...
        <h2 id="a28">&sect;28. Hinge pin <a href="#top" title="top of page"><i class="fa fa-arrow-up" aria-hidden="true"></i></a></h2>
        ...
        <p>So that I join the polymide tube easily to the clip, I wrap it in a fold of carbon, inserting a carbon rod so the tube doesn't collapse. I can easily add epoxy to this and sand etc for a good fit.</p> 


        <h2 id="a29">&sect;29. Gluing in the polymide tube <a href="#top" title="top of page"><i class="fa fa-arrow-up" aria-hidden="true"></i></a></h2>
        <p>It's important to glue the polymide tube such that when the clip is installed the clip sits flush with the closing panels. I 
        found the easiest way to do this is to build up the clip with small strips of carbon, such that there is a slight gap 
        between the clip and the installed polymide tube. I next clamp the bag closed, install the polymide tube with the hinge 
        pins and then clamp the clip in place. I then mix up some black epoxy and carefully add a few drops along the length 
        of the polymide tube such tha it will fill the gap betwen the tube and the clip. This way the polymide tube is glued 
        in the correct posiion. Once the epoxy has cured I an add more epoxy and sand to shape making sue that I don't block 
        the polymide tube.</p>

        <p>Once the clip has the polymide tube installed glued I can glue on the closing panels. I sanded and washed the lip 
        and closing panels. With the bag clamped closed and the clip n the closed position, with a foam brush I dab a thin 
        layer of black epoxy on the closing panels making sue I apply glue to the corerct size. Once in posiion I clamp them.</p>



        <h2 id="a30">&sect;30. Ultrasuede lining <a href="#top" title="top of page"><i class="fa fa-arrow-up" aria-hidden="true"></i></a></h2>
        ...
        <h2 id="a31">&sect;31. End panels - flat <a href="#top" title="top of page"><i class="fa fa-arrow-up" aria-hidden="true"></i></a></h2>
        <p>1 layer of twill<br>2 layers of plain</p>


        <h2 id="a32">&sect;32. Strap <a href="#top" title="top of page"><i class="fa fa-arrow-up" aria-hidden="true"></i></a></h2>
        <p>On the top of the end panels I have my strap release mechanism. The removable plate is now circular with a vertical slot in it. When making the large hole through the end panel I should have previously stuck in the two carbon fiber strips, to save me having to drill the hole again in the strips. Also I cocked up the magnets slightly. Firstly the removable round discs should not have magnets in them, just a bit of steel as I don't want these sticking to anything in the bag and becoming detached from the bag. Secondly I put the side panels stops on after I had drilled the hole and then had to dig out a rectangular hole for the magnet. It would have been a lot easier if i had stuck a thin bit of cf on the outside part of the end panels and stuck the magent on top of that, that way I would have got the magnet as close as possible to the disc. As it was I wasn't sure how far I could dig the hole.</p>
        ...
        <h2 id="a33">&sect;33. Putting it all together <a href="#top" title="top of page"><i class="fa fa-arrow-up" aria-hidden="true"></i></a></h2>
        ...
        <h2 id="a34">&sect;34. Gluing it together <a href="#top" title="top of page"><i class="fa fa-arrow-up" aria-hidden="true"></i></a></h2>
        <p>In the next bag, it may be worth chamfering edges of the side and bottom panels, such that there is an undercut, this will hopefully allow any excess glue to settled.</p>
        ...
        <h2 id="a29">&sect;29. Cross section <a href="#top" title="top of page"><i class="fa fa-arrow-up" aria-hidden="true"></i></a></h2>
        ...
        <h2 id="a30">&sect;30. Polishing notes <a href="#top" title="top of page"><i class="fa fa-arrow-up" aria-hidden="true"></i></a></h2>
        ...
        <h2 id="a31">&sect;31. Suppliers I have used <a href="#top" title="top of page"><i class="fa fa-arrow-up" aria-hidden="true"></i></a></h2>
        ...
        <h2 id="a33">&sect;32. Variants <a href="#top" title="top of page"><i class="fa fa-arrow-up" aria-hidden="true"></i></a></h2>

        <h3 id="mc0">MC00</h3>
           <p>Very early protoype. <img src="./images/mc00/mc00_end.png" alt="MC00 end"> <img src="./images/mc00/mc00_lip.png" alt="MC00 lip">
        <img src="./images/mc00/mc00_clip.png" alt="MC00 clip">  <img src="./images/mc00/mc00_clip2.png" alt="MC00 clip2">
        <img src="./images/mc00/mc00_magnets.png" alt="MC00 magnets"></p>

        <p>Very early protoype. <img src="./images/mc00b/mc00b_side.png" alt="MC00b side"> <img src="./images/mc00b/mc00b_side2.png" alt="MC00b side 2">
        <img src="./images/mc00b/mc00b_side3.png" alt="MC00b side 3">   <img src="./images/mc00b/mc00b_clip.png" alt="MC00b clip">
        <img src="./images/mc00b/mc00_inside.png" alt="MC00b inside"></p>
        ...
        <p><img src="./images/mc0/mc0_end.png" alt="MC0 end"> <img src="./images/mc0/mc0_brokenClip.png" alt="MC0 broken clip">
        <img src="./images/mc0/mc0_inside.png" alt="MC0 inside">  <img src="./images/mc0/mc0_lip.png" alt="MC0 lip">
        <img src="./images/mc0/mc0_signature.png" alt="MC0 signature"> <img src="./images/mc0/mc0_strapHole.png" alt="MC0 strap hole"></p>

        <h3 id="mc1">MC1</h3>
        <ul class="variants">
          <li>First bag with hinged clip.</li>
          <li>Original larger bag.</li>
          <li>1.5" radius lip.</li>
          <li>Rounded bottom.</li> 
        </ul>

        <p><img src="./images/mc1/mc1_side.png" alt="MC1 side"> <img src="./images/mc1/mc1_side2.png" alt="MC1 side 2">
        <img src="./images/mc1/mc1_inside.png" alt="MC1 inside">  <img src="./images/mc1/mc1_inside2.png" alt="MC1 inside 2">
        <img src="./images/mc1/mc1_clip.png" alt="MC1 clip"> <img src="./images/mc1/mc1_clip2.png" alt="MC1 clip 2">
        <img src="./images/mc1/mc1_clip3.png" alt="MC1 clip 3"> <img src="./images/mc1/mc1_clip4.png" alt="MC1 clip 4"></p>
        ...
        <ul class="variants">
          ...
          <li>New Ultrasuede end panels</li>
          <li>Flat bottom</li>
          <li>This is Aimee's bag</li>
        </ul>

        <h3 id="mc3">MC3</h3>
        <ul class="variants">
          <li>Tried to get the end panels ending in a flat section.</li>
          <li>I used the existing acrylic mould and added extra epoxy to the lip which I sanded down to get the two lips to meet correctly. I couldn't manage it and decided that I needed a new mould to do this.</li>
          <li>Bag not completed and I stopped after making the lip on the flat panel.</li>
        </ul>

        <h3 id="mc4">MC4</h3>
        <ul class="variants">
          <li>New mould to stop the end panels ending in a point. Didn't get the mould quite right.</li>
          <li>Diameter of lip 1 1/8"</li>
          <li>Satin finish which didn't look that good.</li>
          <li>Thinner lip.</li>
          <li>Bag not completed.</li>
        </ul>

        <p>Main panels of MC3 and MC4  <img src="./images/mc3_4/mc3_4.png" alt="MC3 & 4 main panel"></p> vmT3rW3BAun56IESeBRz44qPd5MYRJnt7cgvA4wtvMmxvWSuXKbWc9bThLyT
        ...
        <p>Matt bottom, side and end panels <img src="./images/mc5/bottom_panel.png" alt="MC5 bottom panel"><img src="./images/mc5/bottom_panel2.png" alt="MC5 bottom panel"><img src="./images/mc5/side_panel.png" alt="MC5 side panel"><img src="./images/mc5/end_panel.png" alt="MC5 end panel"></p>
        ...
        <p>These images are either of a MC6 or MC7, not sure why it wasn't completed <img src="./images/mc6_7/mc6_or_7.png" alt="mc6 or 7"><img src="./images/mc6_7/mc6_or_7_b.png" alt="mc6 or 7"></p>

        <h3 id="mc8">MC8</h3>
        <ul class="variants">
          <li>Same as mould as MC7 but using carbon &amp; kevlar. This is Robin's bag</li>
        </ul>

        <h3 id="mc8">MC9</h3>
        <ul class="variants">
          <li>Same as mould as MC7 &amp; MC8</li>
          <li>Using patterened labyrinth carbon</li>
          <li>Make the clip cutout bigger so that the clip can fold back completly. This will make it less likely for the hing pin to break if it gets caught</li>
          <li>Thinking again about having a continuos hinge pin. It would allow be to have a much thicker pin and I think I can hold it in place by just having a tight fit.</li>
        </ul>

        <h2 id="a33">&sect;33. Odds &amp; ends <a href="#top" title="top of page"><i class="fa fa-arrow-up" aria-hidden="true"></i></a></h2>

        <p>The thickeness of cf afer cured in a vacuum bag are as follows:</p>
        <ul><li>1 layer of TAP plain = 0.25mm</li>
        <li>1 layer of uni-lateral = 0.21mm</li>
        <li>1 layer of twill, not sure but I am guess it will be around 0.2mm or less</li></ul>



        <h2 id="a34">&sect;34. Order of construction <a href="#top" title="top of page"><i class="fa fa-arrow-up" aria-hidden="true"></i></a></h2>
        ...
        <h2 id="a35">&sect;35. What I don't like about the bag <a href="#top" title="top of page"><i class="fa fa-arrow-up" aria-hidden="true"></i></a></h2>
        <ul>
          <li>The gloss surface scratches and shows finger prints.</li>
          <li>Where I cut the end panels you can see the awlgrip coming off slightly</li>
          <li>Bottom of the bag has a slight wave in it.</li>
        </ul>
        
        <h2 id="a36">&sect;36. Templates <a href="#top" title="top of page"><i class="fa fa-arrow-up" aria-hidden="true"></i></a></h2>
        <ul>
          <li><a href="./bottom_mc8.pdf">MC8a (10.9cm wide)</a></li>
          <li><a href="./bottom_mc8_v2.pdf">MC8b &amp; 9 (10.7cm wide)</a></li>
          <li><a href="./side_section_mc8.pdf">Template for MC7, 8 &amp; 9</a></li>
        </ul>

        <h2 id="materials">Small bag <a href="#top" title="top of page"><i class="fa fa-arrow-up" aria-hidden="true"></i></a></h2>
